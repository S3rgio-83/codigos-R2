...
void setup()
{
  ...
  FLD.selectScrollTextLeft("... R2   \n   D2 ...", LogicEngineRenderer::kRed, 0, 15);
  ...
  DEBUG_PRINTLN("Ready");
   ...
   //prueba para ESP32
 pinMode(PIN_AUX1,OUTPUT); digitalWrite(PIN_AUX1, LOW); //PERISCOPIO
 pinMode(PIN_AUX2,OUTPUT); digitalWrite(PIN_AUX2, LOW); //BAD MOTIVADOR
 pinMode(PIN_AUX3,OUTPUT); digitalWrite(PIN_AUX3, LOW); //Zapper
 pinMode(PIN_AUX4,OUTPUT); digitalWrite(PIN_AUX4, LOW); //Sable Luz
 pinMode(PIN_AUX5,OUTPUT); digitalWrite(PIN_AUX5, LOW); //RADAR
